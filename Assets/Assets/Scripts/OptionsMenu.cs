...
public class OptionsMenu : MonoBehaviour
{
    ...
    public void SelectTrack()
    {
        ...
        // Return to main menu and show main menu panel
        BackToMainMenu();
    ...
    {
        // Clean up button listeners when disabled
        if (previousTrackButton != null)
        {
            previousTrackButton.onClick.RemoveListener(ToggleTrack);
        }
        if (nextTrackButton != null)
        {
            nextTrackButton.onClick.RemoveListener(ToggleTrack);
        }
        if (selectButton != null)
        {
            selectButton.onClick.RemoveListener(SelectTrack);
        }
        if (backButton != null)
        {
