...
public class FinishLine : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        // Check if it's a car by looking for any car controller component
        bool isPlayer1 = false;
        bool isCar = false;

        // Try to get any car controller component
        ...
        // If no component found, check parent object
        if (carController == null && backupController == null && aiController == null && other.transform.parent != null)
        {
        ...
        // Determine if it's a car and which player
        if (carController != null || backupController != null || aiController != null)
        {
            isCar = true;
            isPlayer1 = other.gameObject.name.Contains("Player1") || 
